...
class BaseAgent(ABC):
    ...
    def get_pattern_based_prompt(self):
        ...
        try:
            ...
            # Use base prompt instead of generate_daily_prompt to prevent recursion
            return self.generate_base_prompt()
        except Exception as e:
            # Fallback to base prompt if pattern analysis fails
            return self.generate_base_prompt()
    ...
    def predict_commitment_success(self, commitment_text):
        ...
        try:
            ...
            return 0.5  # Default probability if analysis fails